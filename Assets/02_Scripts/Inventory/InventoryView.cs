...
public class InventoryView : MonoBehaviour
{
    ...
    public bool IsPanelActive => (_inventoryFacade != null ? _inventoryFacade.gameObject : _inventoryUIPanel)?.activeSelf ?? false;
